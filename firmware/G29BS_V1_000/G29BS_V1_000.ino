/*
   Versão: v1.001 Ajustada - Sistema de Leitura de Pressão e Saída de Tensão para Simulador de Freio
   Autor: Assistente ChatGPT
   Data: 2024

   Alterações nesta versão:
   1. Correções nos limites do display para evitar ruído.
   2. Garantia de que todas as coordenadas estão dentro do intervalo permitido (0 a 127 para X e 0 a 63 para Y).
   3. Melhorias na segurança do desenho do gráfico e preenchimento.
*/
...
void loop() {
  ...
  if (millis() - lastUpdate > 100) {
    ...
    // Eixos do gráfico
    display.drawLine(0, GRAPH_HEIGHT - 1, GRAPH_WIDTH, GRAPH_HEIGHT - 1, WHITE); // Eixo X
